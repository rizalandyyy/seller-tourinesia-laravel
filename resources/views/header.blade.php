...
<!-- Mirrored from dompet.dexignlab.com/xhtml/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 03 Aug 2021 02:08:34 GMT -->
<head>
    ...
    ***********************************-->
    <div id="main-wrapper">
        ...
        ***********************************-->
        ...
        <img src="{{ URL::asset('images/tourinesia1.png') }}" width="150" alt=""/>
            </a>
        ...
        <div class="dlabnav">
            <div class="dlabnav-scroll">
				<ul class="metismenu" id="menu">
                    ...
                    <li><a href="profiltoko" class="ai-icon" aria-expanded="false">
						<i class="flaticon-050-info"></i>
							<span class="nav-text">Profil Toko</span>
						</a>
                    </li>
                    <li><a href="performa" class="ai-icon" aria-expanded="false">
							<i class="flaticon-041-graph"></i>
							<span class="nav-text">Performa Toko</span>
						</a>
                    </li>
                    <li><a href="produk" class="ai-icon" aria-expanded="false">
							<i class="flaticon-086-star"></i>
							<span class="nav-text">Produk</span>
						</a>
                    </li>
                    <li><a href="pesanan" class="ai-icon" aria-expanded="false">
							<i class="flaticon-045-heart"></i>
							<span class="nav-text">Pesanan</span>
						</a>
                    </li>
                    <li><a href="gift" class="ai-icon" aria-expanded="false">
